...
export default {
  ...
  methods: {
    store() {
      this.$axios
        .post(`https://nuxt-quiz-70f35-default-rtdb.firebaseio.com/questions.json`, this.quiz)
        .then(res => {
    ...
    storeAnswer(id) {
      this.$axios
        .post(`https://nuxt-quiz-70f35-default-rtdb.firebaseio.com/answers.json`, {
          question_id: id,
          answer: this.correct
        })
        .then(result => {
          this.$router.push('https://nuxt-quiz-70f35-default-rtdb.firebaseio.com/admin/questions')
        })
        .catch(err => {
          console.log(err.response.data)
        })
