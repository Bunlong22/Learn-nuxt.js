...
export default {
  ...
  methods: {
    get() {
      this.$axios
        .get(`https://nuxt-quiz-70f35-default-rtdb.firebaseio.com/questions.json`, this.$route.params.edit)
    ...
    update() {
      this.$axios
        .$patch(`https://nuxt-quiz-70f35-default-rtdb.firebaseio.com/questions/${this.$route.params.edit}.json`, this.quiz)
        .then(res => this.updateAnswer())
    },
    getAnswer() {
      this.$axios
        .$get(
          `https://nuxt-quiz-70f35-default-rtdb.firebaseio.com/answers.json?orderBy="question_id"&startAt="${
    ...
    updateAnswer() {
      this.$axios
        .patch(`https://nuxt-quiz-70f35-default-rtdb.firebaseio.com/answers/${this.answer_id}.json`, {
